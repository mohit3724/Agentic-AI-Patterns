...
```bash
python -m shortlist_builder.agentic.cli_agentic   --input sample_input/sample_student.json   --output sample_output/sample_student_shortlist_agentic.json
```
...
```bash
python -m shortlist_builder.pipeline_cli   --input sample_input/sample_student.json   --output sample_output/sample_student_shortlist_classic.json
```
